...
__published:	// IDE-managed Components
	...
	void __fastcall BusStopSeriesClickPointer(TCustomSeries *Sender, int ValueIndex,
          int X, int Y);
	void __fastcall BusSeriesGetMarkText(TChartSeries *Sender, int ValueIndex, UnicodeString &MarkText);
